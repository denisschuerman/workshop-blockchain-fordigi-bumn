      ...
      <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
        <div className="space-y-3">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
            Workshop Blockchain Fordigi BUMN
          </h2>
          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            Explore our wide range of components. Click on any component to
            learn more.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-6">
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>Simple Blockchain</CardTitle>
                <CardDescription>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>Ballot Voting</CardTitle>
                <CardDescription>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                ...
                <CardDescription>
                  A secure wallet for your digital assets.
                </CardDescription>
              </div>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                ...
                <CardDescription>
                  Organize your tasks with our ToDo List.
                </CardDescription>
              </div>
            </CardHeader>
          </Card>
